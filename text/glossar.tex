...
\section{Schätzen \& Konfindenzintervalle}
...
\begin{itemize}[itemsep=0.4em, topsep=0.4em, parsep=0em, labelsep=0.5em, leftmargin=*, align=parleft]
  ...
  \item Anteil / Wahrscheinlichkeit: $\rho$
\end{itemize}
...
\begin{itemize}[itemsep=0.4em, topsep=0.4em, parsep=0em, labelsep=0.5em, leftmargin=*, align=parleft]
  ...
  \item Schätzer:
  \begin{itemize}[itemsep=0.4em, topsep=0.4em, parsep=0em, labelsep=0.5em, leftmargin=*, align=parleft]
    \item $\bar{X}$ = Zufallsvariable „Stichprobenmittelwert“
    \item $\hat{p}$ = Zufallsvariable „Stichprobenanteil“
...
Ideal: zufällig, unabhängig, repräaentativ
